...
const ITEM_NAMES = {
  "5f49f72c1e": "39000 Shiny Pebbles",
  "ac557f0829": "18000 Shiny Pebbles",
  "58d4537ade": "8000 Shiny Pebbles",
};
...
exports.handler = async (event) => {
  try {
    ...
    const purchasedItem = ITEM_NAMES[itemId];
    ...
    if (!purchasedItem) {
      ...
      return {
        statusCode: 400,
        body: `Unknown product ID: ${itemId}`,
      };
    }
